...
QT_MOC_LITERAL(3, 15, 15), // "unitNameChanged"
QT_MOC_LITERAL(4, 31, 2), // "id"
QT_MOC_LITERAL(5, 34, 4), // "name"
QT_MOC_LITERAL(6, 39, 6), // "remove"
QT_MOC_LITERAL(7, 46, 5), // "Unit*"
QT_MOC_LITERAL(8, 52, 8), // "unitEdit"
QT_MOC_LITERAL(9, 61, 7), // "addUnit"
QT_MOC_LITERAL(10, 69, 14) // "setNewUnitName"

    },
    "Units\0updated\0\0unitNameChanged\0id\0"
    "name\0remove\0Unit*\0unitEdit\0addUnit\0"
    "setNewUnitName"
};
...
void Units::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Units *_t = static_cast<Units *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updated(); break;
        case 1: _t->unitNameChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: _t->remove((*reinterpret_cast< Unit*(*)>(_a[1]))); break;
        case 3: _t->addUnit(); break;
        ...
        {
            typedef void (Units::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Units::updated)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Units::*_t)(int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Units::unitNameChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Units::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Units.data,
      qt_meta_data_Units,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 1
void Units::unitNameChanged(int _t1, const QString & _t2)
{
